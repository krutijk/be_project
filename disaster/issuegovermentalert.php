...
if(!$result) {
    echo "<script>alert('Insertion Failed. Please retry!');
          window.location.href='./issuegovermentalert.html';
        </script>";
}
    ...
    $body  = 'A Government Alert has been issued. There is a '.$calamity.' occuring in '.$state.'. Take the precautionary measures immediately.';
    try {
        //Server settings
